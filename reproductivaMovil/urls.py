...
url(r'^salto_mensaje/$', views.salto_mensaje, name="salto_mensaje"),
    ...
    url(r'^redireccion/$', views.redirigirPaginaBlog, name="redireccion"),
    url(r'^redireccion2/$', views.redirigirPaginaBlogContenido, name="redireccion2"),
    ...
    url(r'^detalle_noticia/$', views.detalleNoticias, name="detalle_noticia"),
    ...
    url(r'^comentario_contenido/$', views.agregarComentarioBlogContenido, name="comentario_contenido"),
    url(r'^dudas_refuentes/$', views.dudasFrecuentes, name="dudas_frecuentes"),
    ...
    url(r'^detalle_dudas/$', views.detalleDudasFrecuentes, name="detalle_dudas"),
